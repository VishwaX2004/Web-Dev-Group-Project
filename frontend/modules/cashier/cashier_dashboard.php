...
session_start();
    ...
    // security check if user is logged in and is a cashier
    ...
    // retrieve user and branch information for display and queries
    ...
    //Fetch Recent Transactions for Table (Last 5 orders)
