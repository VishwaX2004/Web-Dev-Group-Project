...
// Get user details (only for branch name, not for sidebar)
            ...
            <table class="returns-table">
                <thead>
                    <tr>
                        ...
                        <th>Qty</th><th>Reason</th><th>Status</th><th>Return Date</th><th>Actions</th>
                    </tr>
                </thead>
                <tbody>
                    <?php if (empty($returns_data)): ?>
                        <tr><td colspan="9">No returns found. <?php echo htmlspecialchars($search); ?></td></tr>
                    <?php else: ?>
