<!DOCTYPE html>
 ...
 <div class="sidebar">
    <div class="top-section">
        ...
        <ul>
            <li><a href="/Web-Dev-Group-Project/frontend/modules/admin/admin_dashboard.php">Admin dashboard</a></li>
            ...
            <li> <a href="/Web-Dev-Group-Project/frontend/modules/admin/Reports_and_Analytics.php">  Reports & Analytics</a> </li>
        </ul>
    </div>
